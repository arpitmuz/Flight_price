...
# DATE OF JOURNEY
date_dep=st.date_input("Enter Your Departure Date:",value="")
Journey_day = int(pd.to_datetime(date_dep, format="%Y-%mm-%dt").day)
Journey_Month = int(pd.to_datetime(date_dep, format="%Y-%mm-%dt").month)
